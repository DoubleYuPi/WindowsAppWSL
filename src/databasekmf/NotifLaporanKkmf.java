 ...
 * @author ASUS
 */
public class NotifLaporanKkmf extends javax.swing.JFrame {

    /**
     * Creates new form NotifLaporan
     */
    public NotifLaporanKkmf() {
        initComponents();
    }
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        try{
            String NamaFile = "C:\\Users\\ASUS\\Documents\\NetBeansProjects\\database1\\src\\databasekmf\\KeluarKMF.jasper";
            
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/databasekmf?useTimezone=true&serverTimezone=UTC", "root", "");
            HashMap param = new HashMap();
            param.put("TglAwal", nomor_awal.getText().toString());
            param.put("TglAkhir", nomor_akhir.getText().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotifLaporanKkmf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotifLaporanKkmf().setVisible(true);
            }
        });
    }
