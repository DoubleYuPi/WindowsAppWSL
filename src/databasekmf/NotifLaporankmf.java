 ...
 * @author ASUS
 */
public class NotifLaporankmf extends javax.swing.JFrame {

    /**
     * Creates new form NotifLaporan
     */
    public NotifLaporankmf() {
        initComponents();
    }
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        try{
            String NamaFile = "C:\\Users\\ASUS\\Documents\\NetBeansProjects\\database1\\src\\databasekmf\\MasukKMF1.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotifLaporankmf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotifLaporankmf().setVisible(true);
            }
        });
    }
