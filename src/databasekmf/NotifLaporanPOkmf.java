 ...
 * @author ASUS
 */
public class NotifLaporanPOkmf extends javax.swing.JFrame {

    /**
     * Creates new form NotifLaporan
     */
    public NotifLaporanPOkmf() {
        initComponents();
    }
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        try{
            String NamaFile = "C:\\Users\\ASUS\\Documents\\NetBeansProjects\\database1\\src\\databasekmf\\POKMF.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotifLaporanPOkmf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotifLaporanPOkmf().setVisible(true);
            }
        });
    }
