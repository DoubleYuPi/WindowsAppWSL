 ...
 * @author ASUS
 */
public class NotifLaporanwsl extends javax.swing.JFrame {

    /**
     * Creates new form NotifLaporan
     */
    public NotifLaporanwsl() {
        initComponents();
    }
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        try{
            String NamaFile = "C:\\Users\\ASUS\\Documents\\NetBeansProjects\\database1\\src\\databasewsl\\MasukWSL.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotifLaporanwsl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotifLaporanwsl().setVisible(true);
            }
        });
    }
